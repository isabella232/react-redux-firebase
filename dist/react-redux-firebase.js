/*! react-redux-firebase.js v2.0.0-beta.3 */
...
})(this, function(__WEBPACK_EXTERNAL_MODULE_274__) {
...
var _every2 = __webpack_require__(108);
...
var _filter2 = __webpack_require__(244);
...
var _size2 = __webpack_require__(114);
...
var _populate = __webpack_require__(19);
...
var watchEvent = exports.watchEvent = function watchEvent(firebase, dispatch, _ref) {
  ...
  (0, _query.setWatcher)(firebase, dispatch, type, watchPath, queryId);
...
var _isNaN2 = __webpack_require__(249);
...
var setWatcher = exports.setWatcher = function setWatcher(firebase, dispatch, event, path) {
...
var asciiToArray = __webpack_require__(154),
...
var arrayEvery = __webpack_require__(152),
    baseEvery = __webpack_require__(159),
    baseIteratee = __webpack_require__(7),
    isArray = __webpack_require__(0),
...
var arrayMap = __webpack_require__(38),
    ...
    baseUnset = __webpack_require__(84),
    castPath = __webpack_require__(12),
    copyObject = __webpack_require__(13),
    customOmitClone = __webpack_require__(197),
...
var baseKeys = __webpack_require__(76),
    ...
    stringSize = __webpack_require__(236);
...
var _createFirebaseInstance = __webpack_require__(56);
...
exports.default = function (fbConfig, otherConfig) {
  return function (next) {
    return function (reducer, initialState, middleware) {
      ...
      firebaseInstance = (0, _createFirebaseInstance.createFirebaseInstance)(fbConfig, configs, store.dispatch);
...
exports.populate = exports.buildChildList = exports.isEmpty = exports.isLoaded = undefined;

var _isFunction2 = __webpack_require__(5);

var _isFunction3 = _interopRequireDefault(_isFunction2);

var _some2 = __webpack_require__(259);
...
var _defaultsDeep2 = __webpack_require__(243);

var _defaultsDeep3 = _interopRequireDefault(_defaultsDeep2);

var _reduce2 = __webpack_require__(257);
...
var _mapValues2 = __webpack_require__(252);
...
var _split2 = __webpack_require__(260);
...
var buildChildList = exports.buildChildList = function buildChildList(state, list, p) {
...
var populate = exports.populate = function populate(state, path, populates, notSetValue) {
  var pathArr = (0, _compact3.default)(path.split('/'));
  var dotPath = pathArr.join('.');
  var data = pathArr.indexOf('profile') === -1 ? (0, _get3.default)(state, 'data') : state;

  if (!state || !(0, _get3.default)(data, dotPath)) {
    return notSetValue;
  }

  var populatesForData = (0, _populate.getPopulateObjs)((0, _isFunction3.default)(populates) ? populates((0, _last3.default)((0, _split3.default)(path, '/')), (0, _get3.default)(data, dotPath)) : populates);
  var dataHasPopluateChilds = (0, _every3.default)(populatesForData, function (populate) {
    return (0, _has3.default)((0, _get3.default)(data, dotPath), populate.child);
  });
  if (dataHasPopluateChilds) {
    return (0, _reduce3.default)((0, _map3.default)(populatesForData, function (p, obj) {
      if ((0, _isString3.default)((0, _get3.default)((0, _get3.default)(data, dotPath), p.child))) {
        var key = (0, _get3.default)((0, _get3.default)(data, dotPath), p.child);
        var pathString = p.childParam ? p.root + '.' + key + '.' + p.childParam : p.root + '.' + key;

        if ((0, _get3.default)(data, pathString)) {
          return (0, _set3.default)({}, p.child, p.keyProp ? _extends(_defineProperty({}, p.keyProp, key), (0, _get3.default)(data, pathString)) : (0, _get3.default)(data, pathString));
        }

        return (0, _get3.default)(data, dotPath);
      }
      return (0, _set3.default)({}, p.child, buildChildList(state, (0, _get3.default)((0, _get3.default)(data, dotPath), p.child), p));
    }), function (obj, v) {
      return (0, _defaultsDeep3.default)(v, obj);
    }, (0, _get3.default)(data, dotPath));
  } else {
    if (pathArr.indexOf('profile') !== -1) {
      return (0, _get3.default)(data, dotPath);
    }

    return (0, _mapValues3.default)((0, _get3.default)(data, dotPath), function (child, childKey) {
      ...
      var resolvedPopulates = (0, _map3.default)(populatesForDataItem, function (p, obj) {
        ...
        if ((0, _isString3.default)((0, _get3.default)(child, p.child))) {
          ...
          var pathString = p.childParam ? p.root + '.' + key + '.' + p.childParam : p.root + '.' + key;
          if ((0, _get3.default)(data, pathString)) {
            return (0, _set3.default)({}, p.child, p.keyProp ? _extends(_defineProperty({}, p.keyProp, key), (0, _get3.default)(data, pathString)) : (0, _get3.default)(state.data, pathString));
          }

          return child;
        }

        return (0, _set3.default)({}, p.child, buildChildList(state, (0, _get3.default)(child, p.child), p));
      });
...
exports.orderedReducer = exports.dataReducer = exports.listenersReducer = exports.errorsReducer = exports.profileReducer = exports.authReducer = exports.timestampsReducer = exports.requestedReducer = exports.requestingReducer = exports.isInitializingReducer = undefined;
...
var getSlashStrPath = function getSlashStrPath(path) {
  return pathToArr(path).join('/');
};

var getDotStrPath = function getDotStrPath(path) {
  return pathToArr(path).join('.');
};
...
var requestingReducer = exports.requestingReducer = function requestingReducer() {
  ...
  switch (type) {
    case START:
      return _extends({}, state, _defineProperty({}, getSlashStrPath(path), true));
    case NO_VALUE:
    case SET:
      return _extends({}, state, _defineProperty({}, getSlashStrPath(path), false));
    default:
      return state;
  }
};
...
var timestampsReducer = exports.timestampsReducer = function timestampsReducer() {
  ...
  switch (type) {
    ...
    case NO_VALUE:
    case SET:
      return _extends({}, state, _defineProperty({}, getSlashStrPath(path), Date.now()));
    default:
      return state;
  }
};
...
var createDataReducer = function createDataReducer() {
  ...
  return function () {
    ...
    switch (action.type) {
      case SET:
        return _extends({}, state, (0, _set3.default)({}, getDotStrPath(action.path), action[actionKey]));
      case NO_VALUE:
        return _extends({}, state, (0, _set3.default)({}, getDotStrPath(action.path), null));
      case LOGOUT:
        if (action.preserve) {
...
var listenersReducer = exports.listenersReducer = (0, _redux.combineReducers)({
  byId: listenersById,
  allIds: allListeners
});
...
exports.updateEmail = exports.updateAuth = exports.updateProfile = exports.verifyPasswordResetCode = exports.confirmPasswordReset = exports.resetPassword = exports.createUser = exports.logout = exports.login = exports.init = exports.createUserProfile = exports.watchUserProfile = exports.unWatchUserProfile = undefined;
...
var setupPresence = function setupPresence(dispatch, firebase) {
  ...
  var _firebase$_ = firebase._,
      _firebase$_$config2 = _firebase$_.config,
      presence = _firebase$_$config2.presence,
      sessions = _firebase$_$config2.sessions,
...
var init = exports.init = function init(dispatch, firebase) {
  ...
  firebase.auth().onAuthStateChanged(function (authData) {
    if (!authData) {
      ...
      return dispatch({ type: _constants.actionTypes.LOGOUT });
    }
...
var updateProfile = exports.updateProfile = function updateProfile(dispatch, firebase, profileUpdate) {
  dispatch({ type: _constants.actionTypes.PROFILE_UPDATE_START, payload: profileUpdate });
...
var _firebaseConnect = __webpack_require__(121);
...
exports.getLoginMethodAndParams = undefined;
...
var _capitalize2 = __webpack_require__(240);
...
var _remove2 = __webpack_require__(258);
...
var _flatMap2 = __webpack_require__(245);
...
var baseUnset = __webpack_require__(84),
    isIndex = __webpack_require__(16);
...
var asciiSize = __webpack_require__(153),
    hasUnicode = __webpack_require__(26),
...
var apply = __webpack_require__(66),
    ...
    customDefaultsMerge = __webpack_require__(196),
...
var baseIsRegExp = __webpack_require__(167),
    baseUnary = __webpack_require__(83),
    nodeUtil = __webpack_require__(101);
...
var basePick = __webpack_require__(174),
    flatRest = __webpack_require__(91);
...
var baseIteratee = __webpack_require__(7),
    basePullAt = __webpack_require__(177);
...
var arraySome = __webpack_require__(70),
    baseIteratee = __webpack_require__(7),
    baseSome = __webpack_require__(180),
    isArray = __webpack_require__(0),
    isIterateeCall = __webpack_require__(27);
...
var baseToString = __webpack_require__(82),
    castSlice = __webpack_require__(85),
    hasUnicode = __webpack_require__(26),
    isIterateeCall = __webpack_require__(27),
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(55), __webpack_require__(35)(module)))
